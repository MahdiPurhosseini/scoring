<?php
    ...
    return array(
        ...
        */
        ...
        "captcha"        => "کد تصویر امنیتی اعتبار لازم را ندارد",
        ...
        */
        'attributes' => array(
            ...
            "departure_date"=>"تاریخ خروج",
            "adults"=>"بزرگسال",
            "children"=>"خردسال",
            "captcha"=>"کد تصویر امنیتی",
            "mobile_verified_at"=>"تایید تلفن همراه",
            "mobile_activation_code"=>"کد تایید تلفن همراه",
            "score"=>"امتیاز",
            "from_rate"=>"از امتیاز",
            "to_rate"=>"تا امتیاز",
        ),
